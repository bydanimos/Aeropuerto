...
public class PAerolineas extends javax.swing.JPanel {
    ...
    public boolean comprobarCompleto(){
        return !(this.txtEditarNombre.getText().equals("") || this.txtEditarPais.getText().equals("") || this.txtEditarPeso.getText().equals("") || this.txtEditarPrecio.getText().equals(""));
    }
    ...
    public void anhadirNuevaAerolinea(){
        Aerolinea aerolinea = new Aerolinea(this.txtEditarNombre.getText(),this.txtEditarPais.getText(),Float.parseFloat(this.txtEditarPrecio.getText()),Float.parseFloat(txtEditarPrecio.getText()));
    ...
    public void borrarAerolinea(){ 
        ...
        a = m.obtenerAerolinea(tablaAerolineas.getSelectedRow());
        if(this.va.esAerolineaBorrable(a)){
            aerolineasBorradas.add(m.obtenerAerolinea(tablaAerolineas.getSelectedRow()));
            m.borrarAerolinea(tablaAerolineas.getSelectedRow());
            if (m.getRowCount()==0){
                botonBorrar.setEnabled(false);
            }else{
                tablaAerolineas.setRowSelectionInterval(0, 0);
