 ...
 */
public class PAviones extends javax.swing.JPanel {
    
    private final VAdministrador va;

    /**
     * Creates new form PAviones
     */
    ...
    public void buscarAviones() {
        ...
        m.setFilas(this.va.obtenerAviones(this.codigoText.getText(), this.aerolineaText.getText(), 2));
    }
